...
pub fn matrix_add_add_sub<R, V1, V2, V3, V4, const T1: bool, const T2: bool, const T3: bool, const T4: bool>(
...
pub fn matrix_sub_self_assign_add_sub<R, V1, V2, V3, const T1: bool, const T2: bool, const T3: bool>(
    a: TransposableSubmatrix<V1, El<R>, T1>,
    b: TransposableSubmatrix<V2, El<R>, T2>,
...
pub fn matrix_add_assign_add_sub<R, V1, V2, V3, const T1: bool, const T2: bool, const T3: bool>(
    a: TransposableSubmatrix<V1, El<R>, T1>,
    b: TransposableSubmatrix<V2, El<R>, T2>,
    mut dst: TransposableSubmatrixMut<V3, El<R>, T3>,
    ring: R
...
pub fn matrix_sub<R, V1, V2, V3, const T1: bool, const T2: bool, const T3: bool>(
    a: TransposableSubmatrix<V1, El<R>, T1>,
    b: TransposableSubmatrix<V2, El<R>, T2>,
    mut dst: TransposableSubmatrixMut<V3, El<R>, T3>,
    ring: R
...
pub fn matrix_add<R, V1, V2, V3, const T1: bool, const T2: bool, const T3: bool>(
    a: TransposableSubmatrix<V1, El<R>, T1>,
    b: TransposableSubmatrix<V2, El<R>, T2>,
    mut dst: TransposableSubmatrixMut<V3, El<R>, T3>,
    ring: R
...
pub fn matrix_add_assign<R, V1, V2, const T1: bool, const T2: bool>(
...
pub fn matrix_sub_self_assign<R, V1, V2, const T1: bool, const T2: bool>(
    val: TransposableSubmatrix<V1, El<R>, T1>,
    mut dst: TransposableSubmatrixMut<V2, El<R>, T2>,
    ring: R
)
...
pub fn matrix_negate_inplace<V, R, const T: bool>(
    mut val: TransposableSubmatrixMut<V, El<R>, T>,
    ring: &R
)
    where R: RingStore,
        V: AsPointerToSlice<El<R>>
{
    for i in 0..val.row_count() {
        for j in 0..val.col_count() {
            ring.negate_inplace(val.at_mut(i, j));
        }
    }
}